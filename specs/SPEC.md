...
- **Visually distinct, not garish.** Where an animation exists to be noticed (e.g. the corner badge), it follows §5.2's "must read as visually distinct" contrast treatment rather than relying on color alone (terminal color support and themes vary), and stays restrained enough not to become its own distraction in an already busy screen.
