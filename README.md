...
- `internal/openfiles/` — the open-files list: per-entry scroll/goto/in-file-find state, open/reuse/fail semantics, and the list-overlay's remove/reorder operations (spec §2.2, §2.3, §2.4).
